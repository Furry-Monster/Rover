...
public:
    bool init(VkInstance instance, VkPhysicalDevice physical, VkDevice device,
              VkSurfaceKHR surface, const QueueFamilyIndices& families,
              u32 width, u32 height);
    void shutdown(VkDevice device);
    bool recreate(VkPhysicalDevice physical, VkDevice device, VkSurfaceKHR surface,
...
private:
    bool create_internal(VkPhysicalDevice physical, VkDevice device, VkSurfaceKHR surface,
                         const QueueFamilyIndices& families, u32 width, u32 height);
