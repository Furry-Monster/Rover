...
public:
    ...
    void         update_buffer(BufferHandle handle, const void* data,
                               usize size, usize offset = 0) override;
    ...
    void cmd_begin_render_pass(CommandListHandle cmd, FramebufferHandle fb,
                               const ClearValue* clear_values, u32 clear_count) override;
    ...
    void cmd_bind_vertex_buffer(CommandListHandle cmd, BufferHandle buffer,
                                u32 binding = 0, usize offset = 0) override;
    void cmd_bind_index_buffer(CommandListHandle cmd, BufferHandle buffer,
                               IndexType type, usize offset = 0) override;

    void cmd_draw(CommandListHandle cmd, u32 vertex_count,
                  u32 instance_count = 1, u32 first_vertex = 0,
                  u32 first_instance = 0) override;
    void cmd_draw_indexed(CommandListHandle cmd, u32 index_count,
