...
TEST_CASE("ClassDB: Object and RefCounted are registered at core startup")
{
    ...
    {
        ClassDB::register_class("EvtTestObject", "Object", []() -> Object* { return new Object(); });
    }
...
TEST_CASE("ClassDB: instantiate creates an instance via the factory")
{
    ...
    {
        ClassDB::register_class("EvtTestObject2", "Object", []() -> Object* { return new Object(); });
    }
...
TEST_CASE("ClassDB: is_parent_class walks the registered chain")
{
    ...
    {
        ClassDB::register_class("CdbTestNode", "Object", []() -> Object* { return new Object(); });
    }
    if (!ClassDB::class_exists("CdbTestNode2D"))
    {
        ClassDB::register_class("CdbTestNode2D", "CdbTestNode", []() -> Object* { return new Object(); });
    }
