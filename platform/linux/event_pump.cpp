...
namespace rover
{
    ...
    EventPump::EventPump(EventBus& bus, Window& window) : bus_(bus), window_(window) {}
                ...
                case SDL_EVENT_MOUSE_BUTTON_UP:
                {
                    ...
                    switch (e.button.button)
                    {
                        case SDL_BUTTON_LEFT:
                            mb.button = MouseButton::Left;
                            break;
                        case SDL_BUTTON_RIGHT:
                            mb.button = MouseButton::Right;
                            break;
                        case SDL_BUTTON_MIDDLE:
                            mb.button = MouseButton::Middle;
                            break;
                        case SDL_BUTTON_X1:
                            mb.button = MouseButton::X1;
                            break;
                        case SDL_BUTTON_X2:
                            mb.button = MouseButton::X2;
                            break;
                        default:
                            continue;
                    }
