...
namespace rover
{
    ...
    struct Transform3D
    {
        ...
        constexpr Transform3D(const Vector3& origin, const Quat& rotation, const Vector3& scale) noexcept
        ...
        [[nodiscard]] Vector3 transform_direction(const Vector3& dir) const noexcept { return rotation * dir; }
