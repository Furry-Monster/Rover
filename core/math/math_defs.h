...
namespace rover
{
    ...
    [[nodiscard]] inline bool is_nearly_equal(f64 a, f64 b, f64 tolerance = EPSILON) noexcept
    {
        return std::abs(a - b) <= tolerance;
    }

    [[nodiscard]] inline bool is_nearly_zero(f64 value, f64 tolerance = EPSILON) noexcept
    {
