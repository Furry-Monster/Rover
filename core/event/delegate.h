...
namespace rover
{
    ...
    public:
        ...
        Delegate(F&& f)
        {
            ...
            constexpr bool use_sbo = sizeof(Callable) <= sbo_size && alignof(Callable) <= sbo_align &&
        ...
        Delegate(Delegate&& other) noexcept
            : invoke_(other.invoke_), destroy_(other.destroy_), move_fn_(other.move_fn_), on_heap_(other.on_heap_)
        {
        ...
        Ret operator()(Args... args) { return invoke_(static_cast<void*>(storage_), std::forward<Args>(args)...); }
